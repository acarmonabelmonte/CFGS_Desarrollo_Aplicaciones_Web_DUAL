...
mkdir %carpeta2%
cd
C:\Users\victo\Desktop\Sistemas\WorkSpaceSistemas\EjerciciosScripts2\%carpeta1%
echo "Entrando a la carpeta %carpeta1%"
timeout 2 > nul
echo "Generando los archivos de texto..."
timeout 2 > nul
echo "Escribir el texto de el documento pepet.txt o pulsar Ctrl + Z y
...
cd C:\Users\adrian\Desktop\DAW DUAL 1º\SI\Mis ejercicios\Exercicis Scripts 2 (DOS) 2 > nul
echo "Cambiando a la carpeta %carpeta2%"
cd
C:\Users\adrian\Desktop\DAW DUAL 1º\SI\Mis ejercicios\Exercicis Scripts 2 (DOS)\%carpeta2%
timeout 2 >nul
