...
public class ComponentsTests {
	...
	/**
	 * Modifiqueu la classe ClientCotitzacionsWS per a que sigui un compoment detectat per Spring 
	 */
	@Test
	...
	/**
	 * Modifiqueu ServeiConsultaEmpreses per a que, en lloc de retornar sempre 0, empri els metodes de ClientCotitzacionsWS
	 */
	@Test
	 ...
	 *   - consultar obteMitjanaDiariaCotitzacions() es mooolt lent, i no volem fer-ho a cada invocacio de infoDiari(), ja que
