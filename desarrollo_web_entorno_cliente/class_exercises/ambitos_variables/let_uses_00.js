...
function varTest() {
    ...
    if (true) {
        var x = 71;             
        console.log(x);         // 71 es la misma var inicial, se modifica su valor 
    }

    console.log(x);             // 71 se muestra el último valor de la var
}
...
function letTest() {
  ...
  if (true) {
      let x = 71;               
      console.log(x);           // 71 diferente variable, declarada dentro de la condición
    }
    
    console.log(x);             // 31 valor inicial de la var x declara al principio del bloque
}


function hoistingTest() {

    console.log(w);             // undefined, no se ha declarado la variable          
